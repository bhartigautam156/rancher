...
replace (
	...
	helm.sh/helm/v4 => github.com/bhartigautam156/helm/v4 v4.1.3-bgtest
...
require (
	...
	github.com/rancher/system-upgrade-controller/pkg/apis v0.0.0-20260325155902-ed9bde1beaea
